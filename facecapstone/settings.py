"""
Django settings for facecapstone project.
...
ROOT_URLCONF = 'facecapstone.urls'
...
WSGI_APPLICATION = 'facecapstone.wsgi.application'
...
# Where `collectstatic` puts files that will be served by the web server
